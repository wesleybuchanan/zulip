...
def fetch_initial_state_data(user_profile, event_types, queue_id,
    ...
    if want('update_global_notifications'):
        ...
        state['enable_persistent_desktop_notifications'] = user_profile.enable_persistent_desktop_notifications
...
def apply_event(state, event, user_profile, include_subscribers):
    ...
    if event['type'] == "message":
        ...
        elif event['notification_name'] == "enable_persistent_desktop_notifications":
            state['enable_persistent_desktop_notifications'] = event['setting']
    else:
